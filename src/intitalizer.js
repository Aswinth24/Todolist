...
const projectSelection = document.querySelector(
...
function initialize() {
  ...
  const projectDiscardPopPop = document.querySelector(
    ".pop_pop_notification_for_project_discard"
  );
  const workingOfDeleteProject = (index) => {
    //const index=e.target.getAttribute('data-index');
    document.querySelector("#project_title_to_delete").textContent =
    ...
    document
      .querySelector("#cancel_project")
      .addEventListener("click", closeProjectDiscardPopPop);
...
const view_conten_active = document.querySelector(".view-content");
...
const addAndRemoveMenuNavBar = () => {
  ...
  view_conten_active.classList.toggle("active");
...
window.addEventListener("resize", () => {
  if (
    ...
    view_conten_active.classList.contains("active") &&
    headerActive.classList.contains("active")
  ) {
...
const taskTitleSelectionList = document.querySelector(
...
const newTaskFormFunction = () => {
  ...
  newTaskDueDate.addEventListener("click", () => {
    if (
      !priorityPop.classList.contains("active") &&
      !projectSelection.classList.contains("active")
    ) {
  ...
  newTaskForm.addEventListener("submit", (e) => {
    ...
    createTaskObject(
      newTaskTitle.value,
      newTaskProjectTitle.textContent,
      newTaskDescription.value,
      newTaskPriority.textContent,
      newTaskDueDate.textContent
    );
    updateTotalTask();
    createTask();
    storeTaskLists();
         ...
         <div class="task-box">
             <div class="task-content">
                ...
                <div class="options">
                   ...
                   <div class="content-priority" style='background-color:${colorFind(
                     taskDetials[i].getPriority()
                   )}'>
